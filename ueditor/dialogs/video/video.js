...
(function(){
    ...
    function convert_url(s){
        return s.replace(/http:\/\/www\.tudou\.com\/programs\/view\/([\w\-]+)\/?/i,"http://www.tudou.com/v/$1")
            ...
            .replace(/http:\/\/video\.orthonline\.com\.cn\/watch_video.php\?v=([\w\-]+)/i,"http://video.orthonline.com.cn/player/pak_player/pakplayer.swf?config=http%3A%2F%2Fvideo.orthonline.com.cn%2Fplayer%2Fpak_player%2Fembed_player.php%3Fvid%3D"+"$1"+"%26json%3Dtrue%26autoplay%3DYes");
    }
    ...
    function createPreviewVideo(url){
      ...
      var orth = url.match(/video.orthonline\.com\.cn\/watch_video.php\?v=(\w+)/);
  		if (matches){
  			url = "https://www.youtube.com/v/" + matches[1] + "?version=3&feature=player_embedded";
  		}else if(youku){
        url = "http://player.youku.com/player.php/sid/"+youku[1]+"/v.swf"
      }else if(orth) {
        url = "http://video.orthonline.com.cn/player/pak_player/pakplayer.swf?config="
             + "http%3A%2F%2Fvideo.orthonline.com.cn%2Fplayer%2Fpak_player%2Fembed_player.php%3Fvid%3D" 
             + orth[1] 
             + "%26json%3Dtrue%26autoplay%3DYes";
